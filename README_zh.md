...
<p align="center">
  <a href="https://labex.io/zh/courses/host-based-security-auditing">
    <img src="https://course-cover.labex.io/host-based-security-auditing.png?lang=zh" alt="基于主机的安全与审计">
  </a>
</p>

利用 AIDE 进行文件完整性监控，并使用 auditd 进行底层系统审计，从而强化主机安全。学习解析系统日志，以检测暴力破解攻击和权限提升行为。

[在 LabEx 开始课程](https://labex.io/zh/courses/host-based-security-auditing)

## 练习

|   序号 | 名称               | 难度   | 练习                                                                                                                                             |
|------|------------------|------|------------------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 文件完整性监控 (FIM)    | 初级   | <a target='_blank' href='https://labex.io/zh/labs/linux-file-integrity-monitoring-fim-656122?course=host-based-security-auditing'>开始实验</a>     |
|    2 | 使用 Auditd 进行系统审计 | 初级   | <a target='_blank' href='https://labex.io/zh/labs/linux-system-auditing-with-auditd-656123?course=host-based-security-auditing'>开始实验</a>       |
|    3 | 系统日志分析           | 初级   | <a target='_blank' href='https://labex.io/zh/labs/linux-system-log-analysis-656124?course=host-based-security-auditing'>开始实验</a>               |
|    4 | 主机安全加固挑战         | 中级   | <a target='_blank' href='https://labex.io/zh/labs/linux-host-security-hardening-challenge-656121?course=host-based-security-auditing'>开始挑战</a> |
